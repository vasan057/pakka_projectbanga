...
<div class="clearfix">&nbsp;</div>
    ...
    <div class="panel panel-default">
        ...
        <div class="col-md-6">
            <div class="col-md-6">
            <button class="btn btn-norm pull-right" id="submit-all" data-status="2" data-url="{{url('offer/accept')}}">Accept All</button>
    ...
    <div class="col-md-12">
            ...
            <div class="col-md-12" style="display:none;">
                <form action="" method="get" id="search" class="pull-right">
                    ...
                    @endif
                    @endforeach
                    <input type="text" id="search-input" name="q" title="Please enter valid Mandi, PA, Order Number, or Delivery Loc" placeholder="Search.." value="{{$_GET['q'] or ''}}">
                        ...
                        <td>{{round($offer->order_for_price,2)}}</td>                        
                            <td>
                                ...
                                <a href="javascript://" 
                                    ...
                                    data-toggle="modal"
                                    data-target="#myModal"
                                    class="btn btn-norm">Update counter price</a>
                                @endif
                            </td>
                            <td>
                                @if($offer->status == 0 && !$offer->counter_price)
