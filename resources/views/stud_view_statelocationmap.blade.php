...
<!-- endnav -->
        ...
        <div id="page-wrapper" style="min-height: 208px;height: 1145px;">
            <div class="row">
                ...
                <div class="panel panel-default">
                    <div class="panel-body" style="color:#9A1031"><Strong>State Location Mapping Details</Strong></div>
                </div>
                    ...
                    <div class="panel panel-default">
                        ...
                        <div class="panel-body">
                            ...
                            <table style= "width:100%" class="table table-striped table-bordered table-hover" id="dataTables-example">
                                <thead>
                                    <tr bgcolor="#9A1031">
                                        <th class="custom_color">Location ID</th>
                                        <th class="custom_color">State ID</th>
                                ...
                                ?>
                                    ...
                                    <tr class="odd gradeX">                                     
                                        <td contentEditable='true' onClick="showEdit(this);" onBlur="saveToDatabase(this,'location_id','<?php echo $id; ?>')">{{ $user->location_id }}</td>
                                        <td contentEditable='true' onClick="showEdit(this);" onBlur="saveToDatabase(this,'state_id','<?php echo $id; ?>')">{{ $user->state_id }}</td>
    ...
    <script>
		...
		function saveToDatabase(editableObj,column,id) {
            ...
            var table = "statelocationmapping";
           // alert(changed_val);
                $.ajax({
                type:'POST', 
    ...
    <div class="modal-dialog">
      ...
      <!--<form name="myform" id="myform" method="post">-->
        ...
        <div class="form-group">
            ...
            <div class="form-group">
            <label class="col-sm-3 control-label" for="textinput">State ID</label>
            <div class="col-sm-9">
              <input type="text" name="state_id" id="state_id" placeholder="State ID" class="form-control">
            </div><br><br>
            <div class="form-group">
        ...
        <input type='submit' class="btn btn-success" id="updstatelocation" value="Insert Details" />
...
<script>
    $(document).ready(function() {
        $("#updstatelocation").click(function(){
           ...
           // else{
                $.ajax({
                type:'POST', 
                url:'/lsapp/public/getinsertstatelocation', 
                //data:'_token=<?php //echo csrf_token() ?>',
                data:{location_id:location_id,state_id:state_id,active:active,"_token": "{{ csrf_token() }}"},
                success:function(response){ 
