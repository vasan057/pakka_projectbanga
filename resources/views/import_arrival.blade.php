        ...
        <div id="page-wrapper" style="min-height: 208px;height: 865px;">
            <div class="row">
                ...
                <div class="panel panel-default">
                    <div class="panel-body" style="color:#9A1031"><Strong>Upload Arrival Data</Strong></div>
                </div>
            ...
            <div class="row" id="events-table-wrapper">
                <div class="col-lg-12">
                    <div class="panel panel-default">
                        ...
                        <form style="border: 4px solid #a1a1a1;margin-top: 15px;padding: 10px;" action="{{ URL::to('import_arrival') }}" class="form-horizontal" method="post" enctype="multipart/form-data">
                            <input type="file" name="import_file" id="import_file" />
                            <!--    Additional other than webside    -->
                            <br><input type="hidden" name="_token" value="{{ csrf_token() }}">
                            <button class="btn btn-primary" id="upload_arrival">Import File</button>
                        </form>
