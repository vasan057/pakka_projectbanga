...
<!-- endnav -->
        ...
        <div id="page-wrapper" style="min-height: 208px;height: 1145px;">
            <div class="row">
                ...
                <div class="panel panel-default">
                    <div class="panel-body" style="color:#9A1031"><Strong>Mandi Location Mapping Details</Strong></div>
                </div>
                            ...
                            <table style= "width:100%" class="table table-striped table-bordered table-hover" id="dataTables-example">
                                <thead>
                                    <tr bgcolor="#9A1031">
                                        ...
                                        <th class="custom_color">Mandi ID</th>
                                ...
                                ?>
                                    ...
                                    <tr class="odd gradeX">                                     
                                        <td contentEditable='true' onClick="showEdit(this);" onBlur="saveToDatabase(this,'location_id','<?php echo $id; ?>','{{url('getupd')}}')">{{ $user->location_id }}</td>
                                        <td contentEditable='true' onClick="showEdit(this);" onBlur="saveToDatabase(this,'mandi_id','<?php echo $id; ?>','{{url('getupd')}}'">{{ $user->mandi_id }}</td>
    ...
    <script>
		...
		function saveToDatabase(editableObj,column,id,url) {
            ...
            var table = "mandilocationmapping";
           // alert(changed_val);
                $.ajax({
                type:'POST', 
                url:url, 
...
<div class="modal fade" id="myModal1" role="dialog">
    <div class="modal-dialog">
      ...
      <form name="myform" id="myform" method="post" class="form-horizontal">
        ...
        <input type='submit' class="btn btn-success" id="updmandilocation" data-url="{{url('getinsertmandilocation')}}" value="Insert Details" />
...
<script>
    $(document).ready(function() {
        $("#updmandilocation").click(function(){
           ...
           // else{
                ...
                url:url, 
                //data:'_token=<?php //echo csrf_token() ?>',
                data:{location_id:location_id,mandi_id:mandi_id,active:active,"_token": "{{ csrf_token() }}"},
                success:function(response){ 
