...
<div class="clearfix">&nbsp;</div>
    <div class="row">
        <div class="col-md-12">
            ...
            <div class="panel panel-default">
                <div class="panel-body" style="color:#9A1031">
                    <div class="col-md-6">
    ...
    <div class="panel panel-default">
        ...
        <div class="col-md-6">
            <div class="col-md-6">
                @if($status == '0')
                    <button class="btn btn-danger pull-right" id="submit-all" data-status="1" data-url="{{url('order/submit')}}">Submit All</button>
                @endif
                @if($status == '1')
                    <button class="btn btn-danger pull-right" id="submit-all" data-status="2" data-url="{{url('order/accept')}}">Accept All</button>
                @endif
                
            </div>
            <div class="col-md-6 pull-right">
                <button class="btn btn-danger pull-right" data-toggle="modal" data-url="{{url('order')}}" data-type="insert" data-target="#myModal">Add new order</button>
            </div>
        </div>
                ...
                <table style= "width:100%" class="table table-striped table-bordered table-hover" id="dataTables-example">
                    <thead class="header">
                        ...
                        <!--<tr bgcolor="#9A1031">
                            ...
                            <th class="custom_color">Order Date<a href="?sort=order_number&order={{$order or 0}}"></a></th>
                    ...
                    <tbody>
                        ...
                        <td>{{$order->counter_price or ''}}</td>                        
                            ...
                            <td>
                                @if($status == '0')
                                    <a data-id="{{$order->id}}" href="javascript://" data-url="{{url('order/submit')}}" class="btn btn-danger individual-submit">Submit</a>
                                @endif
                                @if($status == '1')
