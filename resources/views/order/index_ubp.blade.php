...
<div class="clearfix">&nbsp;</div>
    ...
    <div class="panel panel-default">
        ...
        <div class="col-md-6">
            <div class="col-md-6">
                ...
                @endif
                @if($status == '1')
                    <button class="btn btn-norm pull-right submit-all" id="" data-status="2" data-url="{{url('order/accept')}}">Accept All</button> 
                    <button class="btn btn-norm submit-all" id="reject-all" data-status="3" data-url="{{url('order/reject')}}">Reject All</button>
                @endif
    ...
    <div class="row" id="events-table-wrapper">
        ...
        <ul class="nav nav-pills nav-justified">
                <li @if($status == '1') class="active" @endif><a href="{{url('order?status=1')}}"><img style="height:2em;width:2em;" src="icons/Submitted.png"></img>&nbsp;&nbsp;Submitted</a></li>
                <li @if($status == '2') class="active" @endif><a href="{{url('order?status=2')}}"><img style="height:2em;width:2em;" src="icons/Accepted.png"></img>&nbsp;&nbsp;Accepted</a></li>
                <li @if($status == '3') class="active" @endif><a href="{{url('order?status=3')}}"><img style="height:2em;width:2em;" src="icons/Accepted.png"></img>&nbsp;&nbsp;Rejected</a></li>
            </ul>
            <div class="panel panel-default">
                <!-- /.panel-heading -->
                ...
                <table style= "width:100%" class="table table-striped table-bordered table-scroll table-hover" id="dataTables-example">
                    <thead class="header">
                        <tr bgcolor="#264595">
                                ...
                                <th class="custom_color">Order Date<a href="?{{$query}}&sort=order_date&order={{$order or 0}}"><i class="fa fa-caret-down" style="color:white;"></i></a></th>
                        ...
                        <td>{{$order->user->user_id or ''}}</td>   
                            <td>
                                ...
                                @if($status == '1')
                                    ...
                                    <a data-id="{{$order->id}}" href="javascript://" data-url="{{url('order/reject')}}" class="btn btn-norm individual-reject">Reject</a>
                                @endif
                            </td>
                        </tr>
                        @endforeach 
