...
<div id="page-wrapper">
    <div class="row">
        ...
        <div class="panel panel-default">
            ...
            <a style="margin-left:  10px;margin-right: 10px;float: right;" href="{{url('ceiling/un-freeze')}}" id='unfreeze_all' class="btn btn-danger @if(!$ceilings->sum('isFrozen')) disabled @endif" >UnFreeze</a>
            <a style="margin-left:  10px;margin-right: 10px;float: right;" href="{{url('ceiling/freeze')}}" id='freeze_all' class="btn btn-success " @if($ceilings->sum('isFrozen')) disabled @endif>Freeze</a>
                    ...
                    <table style= "width:100%" class="table table-striped table-bordered table-hover" id="dataTables-example">
                        ...
                        @foreach ($ceilings as $ceiling)
                            ...
                            <tr class="odd gradeX">                                     
                                ...
                                <td>
                                <button class="btn btn-norm btn-sm set-notify" data-url="{{url('ceiling/set-notify')}}" data-id="{{$ceiling->id}}" @if(!$ceilings->sum('isFrozen')) disabled @endif>Notify</button>
                                </td>
                                </tr>
                            @endforeach 
                        </tbody>
